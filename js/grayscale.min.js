            ...
            success: function(response) {
                ...
                if (response.page.totalElements > 0) {
                    ...
                    for (var i = 0; i < 10; i++) {
                        ...
                        var eventDescriptions = $("<p>").text('Click the "Buy Tickets" button for updated pricing information.');
                    }
                        ...
                        var eventPrice = $("<p>").text('Click the "Buy Tickets" button for updated pricing information.');
                    }
