                ...
                if (response.page.totalElements > 0) {
                    ...
                    for (var i = 0; i < 10; i++) {
                        ...
                        if(results.events[i].classifications && results.events[i].classifications[0]){
                            eventDescriptions.text("Description: " + results.events[i].classifications[0].genre.name);
                        }
                        ...
                        if(results.events[i].priceRanges && results.events[i].priceRanges[0]){
                            eventDescriptions.text("Tickets starting at $" + results.events[i].priceRanges[0].min);
                        }
                        ...
                        thumbnail.attr("src", results.events[i].images[i].url);
