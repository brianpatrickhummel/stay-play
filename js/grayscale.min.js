...
// var startDate = $("#download").val().trim();
// var endDate = $("#contact").val().trim();
var queryURL = "https://app.ticketmaster.com/discovery/v2/events.json?countryCode=US&city=" + city + "&apikey=Y7d6IhdzuKbg2Vw9Vij5Sb1q8q7kP63r";
...
//         var eventDiv = $("<div>");
//         var eventDescriptions = $("<p>").text("Description: " + results.events[0].info);
//         var eventName = $("<p>").text("Name: " + results.events[0].name);
//         var eventStartTime = $("<p>").text("Start Time: " + results.events[0].dates.start.localTime);
//         var eventImage = $("<img>");
//         eventImage.attr("src", results.events[0].images[0].url);
//         eventDiv.append(eventName);
//         eventDiv.append(eventDescriptions);
//         eventDiv.append(eventStartTime);
//         eventDiv.append(eventImage);
//         $(".download-section").append(eventDiv);
...
$.ajax({
  type:"GET",
  url:"https://app.ticketmaster.com/discovery/v2/events.json?size=1&apikey=Y7d6IhdzuKbg2Vw9Vij5Sb1q8q7kP63r",
  async:true,
  dataType: "json",
