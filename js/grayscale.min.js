...
var markers = [];
    ...
    function initialize() {
        var center = new google.maps.LatLng(30.2672654, -97.768282);
...
$("#userInputBtn").on("click", function() {
            ...
            // Gmaps API Geocoding for translating address to latitude & longitude
            var geocoder;
            var map;

            function geocodeInitialize() {
                geocoder = new google.maps.Geocoder();
                var latlng = new google.maps.LatLng(30.2672654, -97.768282);
                // var center = new google.maps.LatLng(30.2672654, -97.768282);
                var mapOptions = {
                    zoom: 8,
                    center: latlng
