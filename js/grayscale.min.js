...
$("#userInputBtn").on("click", function() {
    ...
    var startDate = $("#exampleStartDate").val().trim();
    console.log(startDate);
    // var endDate = $("#contact").val().trim();
    var queryURL = "https://app.ticketmaster.com/discovery/v2/events.json?countryCode=US&city=" + city + "&startDateTime=" + startDate + "&apikey=Y7d6IhdzuKbg2Vw9Vij5Sb1q8q7kP63r";
    ...
    $.ajax({
        ...
        success: function(response) {
            ...
            for (var i = 0; i < 10; i++) {
                var eventDiv = $("<div>");
                var eventDescriptions = $("<p>").text("Description: " + results.events[i].info);
                var eventName = $("<p>").text("Name: " + results.events[i].name);
                var eventStartTime = $("<p>").text("Start Time: " + results.events[i].dates.start.localTime);
                var eventImage = $("<img>");
